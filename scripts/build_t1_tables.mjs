...
const check = await workbook.inspect({kind:'table', range:"'Human decisions'!A1:F6", include:'values,formulas', tableMaxRows:6, tableMaxCols:6});
console.log(check.ndjson);
const preview = await workbook.render({sheetName:'Human decisions', range:'A1:F6', scale:1, format:'png'});
